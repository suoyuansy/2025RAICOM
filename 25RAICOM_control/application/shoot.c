...
void shoot_init(void)
{
    ...
    fp32 Trigger_speed_pid[3] = {TRIGGER_ANGLE_PID_KP, TRIGGER_ANGLE_PID_KI, TRIGGER_ANGLE_PID_KD};
    shoot_control.shoot_mode = SHOOT_STOP; //初始模式为停止射击
    //遥控器指针
    shoot_control.shoot_rc = get_remote_control_point();
    //电机指针
    //shoot_control.shoot_motor_measure = get_trigger_motor_measure_point();  //拨弹电机指针
    //初始化PID
