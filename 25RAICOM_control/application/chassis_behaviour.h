...
typedef enum
{
  ...
  CHASSIS_MY_CONTROL,	                //自定义行为模式
	
	CHASSIS_AUTO_SETTING,               //初始化阶段
	
	CHASSIS_AUTO_CATCHING,                //自动抓取物品模式
	
	CHASSIS_AUTO_LAYING,                  //自动放置物品模式
	
	CHASSIS_AUT0_FOLLOW_YAW,             //根据陀螺仪自动旋转指定角度
	
	CHASSIS_AUT0_MOVING                 //根据雷达数据自动移动
} chassis_behaviour_e;
